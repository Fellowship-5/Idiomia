...
const deleteProverb = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function * () {
    const proverbId = req.params.pid
    const proverb = yield user_methods_js_1.findEntryById(
      proverbId,
      'proverb',
      'could not find the proverb'
    )
    if (proverb.contributor) {
      let proverbToDelete
      try {
        proverbToDelete = yield proverb_js_1.default
          .findById(proverbId)
...
const editProverb = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function * () {
    const proverbId = req.params.pid
    const { proverb, translation, explanation } = req.body
    const proverbToEdit = yield user_methods_js_1.findEntryById(
      proverbId,
      'proverb',
...
const approveProverb = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function * () {
    const proverbId = req.params.pid
    const { approve } = req.body
    const proverbToApprove = yield user_methods_js_1.findEntryById(
      proverbId,
      'proverb',
      'Could not find proverb in database'
    )
    ...
    res
      .status(200)
      .json({ approved_proverb: proverbToApprove.toObject({ getters: true }) })
  })
exports.approveProverb = approveProverb
const getProverbs = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function * () {
    res.json({
