...
router.get(
  '/all-proverbs',
  paginateResponse_1.paginateResponse(proverb_js_1.default),
  admin_controllers_1.getProverbs
)
router.get(
  '/all-users',
  paginateResponse_1.paginateResponse(user_js_1.default),
  admin_controllers_1.getUsers
)
